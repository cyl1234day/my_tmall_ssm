...
<div class="buyPageDiv">
  <form action="forecreateOrder" method="post" id="msgForm">
			...
			<tbody class="productListTableTbody">
				<c:forEach items="${orderItems}" var="oi" varStatus="st" >
					<tr class="orderItemTR">
						<td class="orderItemFirstTD"><img class="orderItemImg" src="img/ProductShow/${oi.product.showImage.id}.jpg"></td>
