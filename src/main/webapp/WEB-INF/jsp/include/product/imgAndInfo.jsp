...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/ProductShow/${product.showImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${product.productShowImages}" var="pi">
                <img src="img/ProductShow/${pi.id}.jpg" bigImageURL="img/ProductShow/${pi.id}.jpg" class="smallImage" style="height: 60px; width: 60px">
            </c:forEach>
        </div>
