			  ...
			  <div>
				<div class="panel panel-warning addPictureDiv">
					  ...
					  <div class="panel-body">
					    	<form method="post" class="addFormSingle" action="admin_productImage_add" enctype="multipart/form-data">
					    		<table class="addTable">
					    			...
					    			<tr class="submitTR">
					    				<td align="center">
					    					<input type="hidden" name="type" value="type_show" />
			  	...
			  	<table class="table table-striped table-bordered table-hover  table-condensed"> 
					...
					<tbody>
						<c:forEach items="${productShowImages}" var="pi">
							<tr>
								<td>${pi.id}</td>
								<td>
								<a title="点击查看原图" href="img/ProductShow/${pi.id}.jpg"><img height="50px" src="img/ProductShow/${pi.id}.jpg"></a>	
								</td>
